{
  ...
  in ''
    ...
    ${ctrl} - return : osascript -e 'tell application "iTerm2" to create window with default profile command ""' || open -na iTerm
    ...
    # Open Emacs
    ${ctrl} + shift - n : /opt/homebrew/bin/emacsclient -a "emacs" -cn
    # Open Firefox window
